    ...
    return (
        ...
        >
            <div className="container text-center">
                <div>
                    <h2 className='font-playfair font-semibold text-[24px] sm:text-[30px] md:text-[36px] lg:text-[40px] xl:text-[44px] max-w-[90%] sm:max-w-[500px] md:max-w-[600px] lg:max-w-[700px] mx-auto w-[450px] text-[#30261C]'>
